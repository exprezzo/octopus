...
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
	...
	<input type="text" name="target" class="txt_target" value="<?php echo $this->datos['target']; ?>" style="width:500px;" />
</div>
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
...
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
	<label style="">Thumb:</label>
	<input type="text" name="thumb" class="txt_thumb" value="<?php echo $this->datos['thumb']; ?>" style="width:500px;" />
</div>
